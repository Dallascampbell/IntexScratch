...
namespace IntexScratch.Models
{
    public class new_intexContext : DbContext
    {
        ...
        public new_intexContext(DbContextOptions<new_intexContext> options)
            : base(options)
        {
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Bodyanalysischart>(entity =>
            {
                ...
                entity.Property(e => e.Cariesperiodontaldisease)
                    .HasColumnName("cariesperiodontaldisease")
                    .HasMaxLength(200);
            ...
            modelBuilder.HasSequence("bodyanalysischart_id_seq");
